...
void Quaternion::rotate(Vector3& vect, long double angleinradians, const Vector3& axis)
{
	vect = getRotated(vect, angleinradians, axis);
}

void Quaternion::rotate(Vector3& vect, const Quaternion& rotor)
{
...
{
	Quaternion::rotate(vect, angleinradians, axis);
}

void rotate(Vector3& vect, const Quaternion& rotor)
{
	Quaternion::rotate(vect, rotor);
}